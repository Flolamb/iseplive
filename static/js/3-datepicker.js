...
var DatePicker = new Class({
	...
	initialize: function(attachTo, options) {
		// Translations
		var t = this;
		t.options.days.each(function(e, i){
			t.options.days[i] = __(e);
		});
		t.options.months.each(function(e, i){
			t.options.months[i] = __(e);
		});
		t.startDay = __('WEEK_FIRST_DAY').toInt();
