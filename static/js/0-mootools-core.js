...
web build:
 - http://mootools.net/core/6ecf79363405b8b02ada5c57093bca2f

packager build:
 - packager build Core/Array Core/Event Core/Browser Core/Class Core/Class.Extras Core/Element Core/Element.Style Core/Element.Event Core/Element.Dimensions Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request Core/Request.JSON Core/Cookie Core/JSON Core/DOMReady
