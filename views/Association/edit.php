...
<div class="associations-column center">
	<form action="?" method="post" enctype="multipart/form-data" id="association-profile">
		<h1><?php echo __('ASSOCIATION_EDIT_TITLE', array('association' => htmlspecialchars($association_name))); ?></h1>
		...
		<div class="profile-info">
			...
			<input type="text" name="name" id="association_edit_name" value="<?php echo htmlspecialchars($association['name']); ?>" /><br />
			...
			<input type="text" name="creation_date" id="association_edit_creation_date" value="<?php echo $association['creation_date']; ?>" /><br />
			...
			<input type="text" name="mail" id="association_edit_mail" value="<?php echo htmlspecialchars($association['mail']); ?>" /><br />
			...
			<textarea name="description" id="association_edit_description" cols="50" rows="5"><?php echo htmlspecialchars($association['description']); ?></textarea>
			<br /><br />
