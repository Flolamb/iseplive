...
<div class="profile-column center">
	<form action="?" method="post" enctype="multipart/form-data" id="group-profile">
		<h1><?php echo __('GROUP_EDIT_TITLE', array('group' => htmlspecialchars($group_name))); ?></h1>
		...
		<div class="profile-info">
			...
			<input type="text" name="name" id="group_edit_name" value="<?php echo htmlspecialchars($group['name']); ?>" /><br />
			...
			<input type="text" name="creation_date" id="group_edit_creation_date" value="<?php echo $group['creation_date']; ?>" /><br />
			...
			<input type="text" name="mail" id="group_edit_mail" value="<?php echo htmlspecialchars($group['mail']); ?>" /><br />
			...
			<textarea name="description" id="group_edit_description" cols="50" rows="5"><?php echo htmlspecialchars($group['description']); ?></textarea>
			<br /><br />
